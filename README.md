...
![Team Photo](t-photos/teamphoto1.jpg)
...
* 🚧 [**Obstacle Management**](#-obstacle-management)
    * 👁️ [Detection Method](#-detection-method)
...
The gyro proved to be an incredibly important sensor for our robot. Initially one of the EV3 gyro sensors were used, however we quickly ran into issues. One issue was that it is highly unreliable. The LEGO gyro tends to drift over time. Another issue was that the gyro didn't have a high angular resolution.
...
We abstracted this way in code by using a state machine architecture. Our obstacle challnge program follow the following procedure:

![State machine diagram]()

### 👁️ [Detection Method](#-contents)
